...
if (isset($_POST['add'])) {
    if (isset($_SESSION['cart'])) {
        ...
        if (in_array($_POST['id'], $item_array_id)) {
            ...
            echo "<script> window.location ='product-women-so-2.php' </script>";
        } else {
...
if (isset($_POST['submit'])) {
    ...
    if ($password === $row['user_password'] && $id === $row['user_id']) {
        ...
        header("location:product-women-so-2.php");
    } else {
...
<body>
    ...
    <div id="main">
        ...
        <div id="body">
            ...
            <div class="container">
                <div id="productTitle">WOMEN FOOTBALL ITEMS</div>
                <div class="row text-center py-3">
                    <?php
                    //câu truy vấn
                    $sql = "select * from product where cate_id = 'SO' and gender = 'female'";
                    ...
                    while ($row = mysqli_fetch_assoc($res)) {
                        ...
                        <div class=\"product-wrapper col-md-3 col-sm-6\">
                            <form action=\"product-women-so-2.php\" method=\"post\">
