...
if (isset($_POST['add'])) {
    if (isset($_SESSION['cart'])) {
        ...
        if (in_array($_POST['id'], $item_array_id)) {
            ...
            echo "<script> window.location ='product-men-ba.php' </script>";
        } else {
...
if (isset($_POST['submit'])) {
    ...
    if ($password === $row['user_password'] && $id === $row['user_id']) {
        ...
        header("location:product-men-ba-2.php");
    } else {
...
<body>
    ...
    <div id="main">
        ...
        <div id="body">
            ...
            <div class="container">
                <div id="productTitle">MEN'S BASKETBALL CLOTHING, SHOES AND ACCESSORIES</div>
                <div class="row text-center py-3">
                    <?php
                    //câu truy vấn
                    $sql = "select * from product where cate_id = 'BA' and gender = 'male'";
                    ...
                    while ($row = mysqli_fetch_assoc($res)) {
                        ...
                        <div class=\"product-wrapper col-md-3 col-sm-6\">
                            <form action=\"product-men-ba.php\" method=\"post\">
